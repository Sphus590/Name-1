#importing shuffle from random libraries
...
def round():
    ...
    while True:
        try:
            ...
            print('please enter questions in numbers only (The maximum number of questions is 10 )')
...
#Main Routine of asking questions and giving score for answers.
while chances>0:
    data = questions[0]
    q = data[0]
    data =data[1]
...
percent = score/total
print ('Your score is: {:.2%}'.format(percent)) 
